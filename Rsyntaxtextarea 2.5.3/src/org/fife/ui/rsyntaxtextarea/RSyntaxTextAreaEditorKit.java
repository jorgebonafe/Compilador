	...
	public static class InsertBreakAction
		...
		protected void handleInsertBreak(RSyntaxTextArea textArea,
			...
			if (noSelection && textArea.isAutoIndentEnabled()) {
				...
				if (noSelection) {
					...
					possiblyCloseTokens(textArea, null);
				}
			}
		}
		...
		private void insertNewlineWithAutoIndent(RSyntaxTextArea sta) {
			...
			try {
				...
				possiblyCloseTokens(sta, leadingWS);
		...
		private void possiblyCloseTokens(RSyntaxTextArea textArea,String leadingWS) {
			...
			if (textArea.getSyntaxEditingStyle().equals("text/legal")) {
				open = new String("Por Favor");
				close = new String("Obrigado");
			}
			if (textArea.getSyntaxEditingStyle().equals("text/jason")) {
				open = new String("Begin");
				close = new String("End");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_esp")) {
				open = new String("Por Favor");
				close = new String("Gracias");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_eng")) {
				open = new String("Please");
				close = new String("Thank You");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_alpha")) {
				open = new String("Por Favor");
				close = new String("Obrigado");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_alpha_esp")) {
				open = new String("Por Favor");
				close = new String("Gracias");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_alpha_eng")) {
				open = new String("Please");
				close = new String("Thank You");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_asuro")) {
				open = new String("Início");
				close = new String("Fim");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_asuro_esp")) {
				open = new String("Inicio");
				close = new String("Fin");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_asuro_eng")) {
				open = new String("Begin");
				close = new String("End");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_alpha_2012")) {
				open = new String("Por Favor");
				close = new String("Obrigado");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_alpha_2012_esp")) {
				open = new String("Por Favor");
				close = new String("Gracias");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_alpha_2012_eng")) {
				open = new String("Please");
				close = new String("Thank You");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_3")) {
				open = new String("Por Favor");
				close = new String("Obrigado");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_3_esp")) {
				open = new String("Por Favor");
				close = new String("Gracias");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_3_eng")) {
				open = new String("Please");
				close = new String("Thank You");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_3_maker")) {
				open = new String("início");
				close = new String("fim");
			}
			else if (textArea.getSyntaxEditingStyle().equals("text/legal_3_maker_eng")) {
				open = new String("begin");
				close = new String("end");
			}
			...
			if (t!=null && t.getLexeme().equalsIgnoreCase(open)) {
				if (getOpenTokenCount(doc,open,close)>0) {
