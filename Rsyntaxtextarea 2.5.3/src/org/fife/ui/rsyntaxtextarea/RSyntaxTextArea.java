...
private boolean fractionalFontMetricsEnabled;
	...
	public int getLocalIdentation(String obrigado) {
		RSyntaxDocument doc = (RSyntaxDocument)this.getDocument();
		int localPosition = getCaretLineNumber();
		String porFavor = "";
		int openCount = 0;

		if (getSyntaxEditingStyle().equals("text/legal")) {
			porFavor = "Por Favor";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_esp")) {
			porFavor = "Por Favor";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_eng")) {
			porFavor = "Please";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_alpha")) {
			porFavor = "Por Favor";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_alpha_esp")) {
			porFavor = "Por Favor";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_alpha_eng")) {
			porFavor = "Please";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_asuro")) {
			porFavor = "início";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_asuro_esp")) {
			porFavor = "início";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_asuro_eng")) {
			porFavor = "begin";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_alpha_2012")) {
			porFavor = "Por Favor";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_alpha_2012_esp")) {
			porFavor = "Por Favor";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_alpha_2012_eng")) {
			porFavor = "Please";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_3")) {
			porFavor = "Favor";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_3_eng")) {
			porFavor = "Please";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_3_maker")) {
			porFavor = "início";
		}
		else if (getSyntaxEditingStyle().equals("text/legal_3_maker_eng")) {
			porFavor = "begin";
		}
		else if (getSyntaxEditingStyle().equals("text/jason")) {
			porFavor = "begin";
		}
		
		int size1 = porFavor.length();
		int size2 = obrigado.length();
		...
		for (int i=0; i<=localPosition; i++) {
			...
			while (t!=null && t.isPaintable()) {
				if (t.length()==size1) {
					...
					if (aux.equalsIgnoreCase(porFavor)) {
						openCount++;
					}
					else if (size1==size2) {
						if (aux.equalsIgnoreCase(obrigado))
							openCount--;
					}
				}
