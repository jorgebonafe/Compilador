...
public class TokenMgrError extends Error {
	...
	public static int getLexState() {
		return lexState;
	}

	public static void setLexState(int lexState) {
		TokenMgrError.lexState = lexState;
	}
}
/*
 * JavaCC - OriginalChecksum=8ec055aec113d4fbf3efcdfad881dafd (do not edit this
 * line)
 */
